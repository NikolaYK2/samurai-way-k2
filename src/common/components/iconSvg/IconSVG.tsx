  ...
  switch (props.name) {
    ...
    case 'logOut':
      return <svg  version="1.1" viewBox="0 0 24 24" width={'100%'} height={'100%'}
                   xmlns="http://www.w3.org/2000/svg"><g id="info"/><g id="icons"><g id="exit2"><path d="M12,10c1.1,0,2-0.9,2-2V4c0-1.1-0.9-2-2-2s-2,0.9-2,2v4C10,9.1,10.9,10,12,10z"/>
